  ...
  return (
    ...
    >
      <DialogContent>
        ...
        <h2 className="text-xl font-bold mt-4">{isReject ? 'Reject' : 'Delete'} {deleteTarget}</h2>
        <p className="text-gray-500 mt-2 text-sm">
          Are you sure you want to {isReject ? 'reject' : 'delete'} this {deleteTarget}? This action
          cannot be undone.
        </p>
